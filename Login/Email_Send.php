			  ...
			  <div class="card-header">
			    <b>ACCOUNT RECOVERED</b>
			  	...
			  	<center>
					...
					<br>
					<br>
			  	<p>YOUR NEW PASSWORD WAS SUCCESSFULLY SENT TO YOUR EMAIL ADDRESS!</p>
			  	<label class="text-center"><b>THANK YOU!</b></label>
			 		</center>

					 <a href="new_Login.php" class="btn btn-default" style="margin-top: 60px;">Back to Login</a>
